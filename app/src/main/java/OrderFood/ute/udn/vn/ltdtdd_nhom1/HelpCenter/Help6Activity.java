...
public class Help6Activity extends AppCompatActivity {
    Button btnback;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnback = (Button) findViewById(R.id.closehelp6);
        btnback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Help6Activity.this, HelpCenterActivity.class);
