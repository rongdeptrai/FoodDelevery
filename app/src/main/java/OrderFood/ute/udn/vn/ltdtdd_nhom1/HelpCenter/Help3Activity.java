...
public class Help3Activity extends AppCompatActivity {
    Button btnback;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnback = (Button) findViewById(R.id.closehelp3);
        btnback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Help3Activity.this, HelpCenterActivity.class);
