...
public class Help7Activity extends AppCompatActivity {
    Button btnback;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnback = (Button) findViewById(R.id.closehelp7);
        btnback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Help7Activity.this, HelpCenterActivity.class);
